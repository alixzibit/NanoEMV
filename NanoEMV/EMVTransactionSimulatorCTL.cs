...
public class EMVTransactionSimulatorCTL
{
    private PCSCReader _cardReader;

    public EMVTransactionSimulatorCTL(PCSCReader cardReader)
    {
    ...
    public byte[] ConstructCDOLalt()
    {
        ...
        Debug.WriteLine($"Constructed CDOL Alt Data: {BitConverter.ToString(cdolData.ToArray()).Replace("-", "")}");
        return cdolData.ToArray();
    }
